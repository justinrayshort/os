...
//! `site_app` binary.
//!
//! In normal local development, start the browser shell with `cargo dev`; that workflow delegates
//! to the same Trunk/WASM pipeline this crate expects at runtime.
